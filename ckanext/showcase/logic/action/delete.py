...
def showcase_package_association_delete(context, data_dict):
    ...
    if showcase_package_association is None:
        raise toolkit.ObjectNotFound(toolkit._("ShowcasePackageAssociation with package_id '{0}' and showcase_id '{1}' doesn't exist.").format(package_id, showcase_id))
...
def showcase_admin_remove(context, data_dict):
    ...
    if showcase_admin_to_remove is None:
        raise toolkit.ObjectNotFound(toolkit._("ShowcaseAdmin with user_id '{0}' doesn't exist.").format(user_id))
